...
async def run_champion_generation(
    ...
    shape_candidates, image_cond, aggregated_tokens_list = pipeline.reconviagen.generate_shapes_only(trellis_req, num_samples=settings.max_candidates)
    ...
    candidates = pipeline.reconviagen.generate_textures_for_shapes(
        trellis_req,
        selected_shapes,
